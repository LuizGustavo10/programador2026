            ...
            <div class="col-md-5">
              <form action="<?=$destino?>" method="post" enctype="multipart/form-data" class="p-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="foto" id="foto" class="form-control" accept="image/*" onchange="mostrarPreview(this, 'previewFoto')">
                    <input type="hidden" name="foto_atual" value="<?php echo isset($mercados) ? $mercados['foto'] : "" ?>">
                    <small class="text-muted">Escolha uma imagem JPG, PNG ou WEBP.</small>
                    <img id="previewFoto" class="img-thumbnail mt-2 d-none" style="width: 120px; height: 80px; object-fit: cover;">
                    <?php if(!empty($mercados['foto']) && file_exists($mercados['foto'])){ ?>
                      <p class="mb-1 mt-2">Foto atual:</p>
                      <img src="<?php echo $mercados['foto'] ?>" class="img-thumbnail mt-2" style="width: 120px; height: 80px; object-fit: cover;">
                    <?php } ?>
                </div>
            ...
            <div class="col-md-5"> 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php if(!empty($coluna['foto']) && file_exists($coluna['foto'])){ ?>
                      <img src="<?php echo $coluna['foto'] ?>" style="width: 60px; height: 45px; object-fit: cover; border-radius: 6px;">
                    <?php } ?>
                  </td>
