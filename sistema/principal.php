            ...
            <div class="col-md-2 bg-dark">
                <aside id="sidebar" class="sidebar p-3 text-white bg-dark">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link" href="#"> <i class="fa-solid fa-user" style="color: rgb(255, 255, 255);"></i> Usuários</a>
                        </li>
                        <li class="nav-item"> 
                            <a class="nav-link" href="#"> <i class="fa-solid fa-shop" style="color: rgb(255, 255, 255);"></i> Mercados</a>
                        </li>
                        <li class="nav-item"> 
                            <a class="nav-link" href="#"> <i class="fa-solid fa-basket-shopping" style="color: rgb(255, 255, 255);"></i> Produtos</a>
                        </li>
                    </ul>
                </aside>
            </div>
